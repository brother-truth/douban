/* Rainbow v2.1.2 rainbowco.de | included languages: generic, html, javascript */
!function (e, t) {
    ...
    function s(t, n) {
        ...
        var g = f + "\tthis.onmessage =" + d, m = new Blob([g], {type: "text/javascript"});
    ...
    function p(e, t) {
        for (var r = {c: 0}, a = 0, o = e; a < o.length; a += 1) {
            ...
            if (!i.classList.contains("rainbow") && u) {
                ...
                ++r.c, d(v(i.innerHTML, {language: u, globalClass: c, delay: s}), g(i, r, t))
            }
        }
        0 === r.c && t()
    }
    ...
    var M, C = function H(e) {
        ...
        function l(r, a, i) {
            ...
            function l(t) {
                var a = m[t];
                if (a) {
                    var i = r.matches[t], u = i.language, s = i.name && i.matches ? i.matches : i,
                        f = function (e, r, a) {
        ...
        function d(e, t) {
            for (var n = 0, r = t; n < r.length; n += 1) for (var a = r[n], o = l(a, e); o;) o = l(a, o.remaining, o.offset);
            return s(e)
        }
        ...
        var v, p = {}, h = {};
        this.refract = m
    }, S = {}, T = {}, x = {}, A = {}, R = e(), k = t(), j = null;
    A = {extend: y, remove: N, onHighlight: w, addAlias: E, color: L}, R && (A.colorSync = function (e, t) {
...
Rainbow.extend("generic", [{
    ...
    pattern: /\bPromise(?=(\(|\.))/g
}], "generic"), Rainbow.addAlias("js", "javascript");